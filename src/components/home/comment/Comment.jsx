        ...
        <div className={styles.header_cards}>
          ...
          <div className={styles.header_card1}>
            ...
            <div className={styles.header_person}>
              <img src={man2} alt="person 1 img" />
              <div>
                <h3>Egamberdi Odilov</h3>
                <p>Dietolog</p>
              </div>
            </div>
          </div>
          ...
          <div className={styles.header_card3}>
            ...
            <div className={styles.header_card3_content}>
              <h4>Sizga yordam berayotganimizdan mamnunmiz </h4>
              <p>Saytimiz orqali sizga yordam berayotganmizdan hursandmiz</p>
            </div>
